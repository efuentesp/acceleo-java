...
public class Fideicomitente implements Serializable {
	...
	@NotNull
	@Column(name = "clavefideicomitente")
	private String clavefideicomitente;
	...
	public String getClavefideicomitente () {
	    return clavefideicomitente;
	    }
	public void setClavefideicomitente(String clavefideicomitente) {
		this.clavefideicomitente = clavefideicomitente;
	}
