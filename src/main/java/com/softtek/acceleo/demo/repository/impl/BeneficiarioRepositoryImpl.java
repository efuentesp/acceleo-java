...
Restrictions.like("beneficiario", "%" + query +"%"))
	...
	public long getTotalRowsSearch(String query) {
		...
		.createCriteria(Beneficiario.class).setProjection(Projections.rowCount())
					.add(	
							Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(Restrictions.or(	
						Restrictions.like("beneficiario", "%" + query +"%"),Restrictions.like("beneficiario", "%" + query +"%")),Restrictions.like("nombre", "%" + query +"%")),Restrictions.like("beneficiario", "%" + query +"%")),Restrictions.like("beneficiario", "%" + query +"%")),Restrictions.like("apellidopaterno", "%" + query +"%")),Restrictions.like("de", "%" + query +"%")),Restrictions.like("apellidomaterno", "%" + query +"%")),Restrictions.like("fechanacimiento", "%" + query +"%")),Restrictions.like("para", "%" + query +"%")),Restrictions.like("es", "%" + query +"%")),Restrictions.like("beneficiario", "%" + query +"%"))	
